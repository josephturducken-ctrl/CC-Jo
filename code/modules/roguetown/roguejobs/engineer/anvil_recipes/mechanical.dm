...
/datum/anvil_recipe/engineering/bronze/tools/drill
	name = "Clockwork Drill (+1 iron, +1 cog, +1 Wooden Plank)"
	req_bar = /obj/item/ingot/bronze
...
/datum/anvil_recipe/engineering/artificerarmor
	name = "Artificer armor (+2 ancient alloy ingot, +2 cog)"
...
/datum/anvil_recipe/engineering/volticgauntlet
	name = "Voltic Gauntlet (+1 Tin ingot, +2 cog, +1 cinnabar ore)"
	req_bar = /obj/item/ingot/bronze
...
/datum/anvil_recipe/engineering/steamshield
	name = "Steam Shield (+1 wood plank, +2 cog, +2 bronze ingot)"
	req_bar = /obj/item/ingot/iron
