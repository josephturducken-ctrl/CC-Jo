...
/datum/action/cooldown/spell/miracle/heal
	...
	cast_range = SPELL_RANGE_GROUND //Caustic Edit - Lets make this on parity with and using the new Spell Defines?
...
/datum/action/cooldown/spell/miracle/fortify
	...
	click_to_activate = TRUE
	cast_range = SPELL_RANGE_GROUND //Caustic Edit - Lets make this on parity with and using the Spell Defines?
	self_cast_possible = TRUE
