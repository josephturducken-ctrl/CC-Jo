...
#define TRAIT_LOOTGOBLIN "Loot Goblin"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_LOOTGOBLIN = span_info("While not necessarily a goblin, I'm quite proficient at stripping things from dead bodies and generally hastier while doing scavenging actions in general."),
