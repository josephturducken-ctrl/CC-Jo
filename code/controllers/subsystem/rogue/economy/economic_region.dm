...
/datum/economic_region/glintskye
	...
	name = "Glintskye" //Glint-Ski
	subtitle = "Glinting Heart of the Desert"
	description = "A vital economic region within Al-Ashur's reach, home to rich agriculture and considered a paradise within these dune-filled wastelands."
	threat_region_id = THREAT_REGION_FRESH_RIVER //Makes sense that the farming route wants the river kept clear.
	produces = list(
		TRADE_GOOD_GRAIN = TG_SUPPLY_LOCAL_GRAIN,
		TRADE_GOOD_OATS = TG_SUPPLY_FOREIGN_GRAIN,
		TRADE_GOOD_RICE = TG_SUPPLY_FOREIGN_GRAIN,
...
//CC Edit - Desert Mappification
/datum/economic_region/lirvas
	region_id = TRADE_REGION_LIRVAS
	name = "Lirvas" //Placeholder do update if you want.
	subtitle = "Major Empire of the North"
	description = "Nothing is yet available on this location."
	threat_region_id = THREAT_REGION_DESERT_UNDERDARK
	produces = list(
		TRADE_GOOD_IRON_ORE = TG_SUPPLY_IRON,
		TRADE_GOOD_COPPER_ORE = TG_SUPPLY_TIN_BRONZE,
		TRADE_GOOD_TIN_ORE = TG_SUPPLY_TIN_BRONZE,
...
/datum/economic_region/deep_dunes_placeholder
	...
	produces = list( //Deeper dunes supplies some of the more important wood.
		...
		TRADE_GOOD_FUR = TG_SUPPLY_LEATHER,
		TRADE_GOOD_CURED_LEATHER = TG_SUPPLY_LEATHER,
		TRADE_GOOD_IRON_INGOT = TG_SUPPLY_REFINED_INGOTS, //Mostly higher tier crafting materials in the deep dunes.
		TRADE_GOOD_STEEL_INGOT = TG_SUPPLY_REFINED_INGOTS,
		TRADE_GOOD_COPPER_INGOT = TG_SUPPLY_REFINED_INGOTS,
		TRADE_GOOD_TIN_INGOT = TG_SUPPLY_REFINED_INGOTS,
		TRADE_GOOD_COAL = TG_SUPPLY_IRON,
