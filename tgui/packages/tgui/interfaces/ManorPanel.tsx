...
const GOD_TOOLTIPS: Record<string, string> = {
  'abyssor': 'Abyssor will bless ponds around your manor, filling them with fish.',
  ...
  switch (kind) {
    ...
    case 'hunt':
      return {
        ...
        overlay: 'transparent',
        chip: 'rgba(24, 14, 8, 0.33)',
        subtitle: 'Fur, hide and game meat',
      };
    case 'farm':
      return {
        accent: '#d4ae71',
    ...
    case 'trade':
      return {
        ...
        overlay: 'transparent',
        chip: 'rgba(24, 14, 8, 0.33)',
        subtitle: 'Commodities and profit',
      };
    case 'fish':
      return {
        accent: '#a2bfe5',
        ...
        overlay: 'transparent',
        chip: 'rgba(24, 14, 8, 0.33)',
        subtitle: 'Fish and treasures of the deep',
      };
    case 'mining':
      return {
        accent: '#e5a2a2',
    ...
    case 'outpost':
      return {
        ...
        overlay: 'transparent',
        chip: 'rgba(24, 14, 8, 0.33)',
        subtitle: 'Protecting peace and order',
      };
    default:
      return {
        accent: '#d9c39a',
...
export const ManorPanel = () => {
  ...
  return (
    <Window title={manor_name || 'Manor'} width={860} height={595}>
        ...
        <div style={{ padding: '12px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 108px', gap: '14px', alignItems: 'center' }}>
              <div>
                ...
                <div style={{ marginTop: '12px', display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                  ...
                  {statBox('Per cycle', productivity_last_cycle)}
                </div>
          ...
          {workstations.length ? (
            ...
            <div style={{
              ...
              This character has no available manor or it has no holdings yet.
            </div>
          )}
        </div>
